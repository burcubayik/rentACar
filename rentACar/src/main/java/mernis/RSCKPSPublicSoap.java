...
public class RSCKPSPublicSoap
{
    ...
    public RSCKPSPublicSoap(){}

    public RSCKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public RSCKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        RSCExtendedSoapSerializationEnvelope envelope= new RSCExtendedSoapSerializationEnvelope(RSCExtendedSoapSerializationEnvelope.VER11);
