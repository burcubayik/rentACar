...
class RSCSoapFaultEx extends org.ksoap2.SoapFault
{
    public Object fault;
}
...
public class RSCExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(RSCDateTimeConverter converter)
    {
        if(converter==null)
        {
            converter = new RSCStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static RSCDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static RSCDateTimeConverter dateTimeConverter = new RSCStandardDateTimeConverter();

    public RSCExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public RSCExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new RSCMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=RSCHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,RSCExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=RSCHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
